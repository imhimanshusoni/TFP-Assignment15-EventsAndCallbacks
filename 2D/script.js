...
for (let i = 0; i < data.recipes.length; i++) {
  for (let j = 0; j < data.recipes[i].tags.length; ++j) {
    arr.push(data.recipes[i].tags[j]);
  }
}
...
document.write(
  `<table style="border: 1px solid black; border-collapse: collapse; margin: 0 auto;"><tr><th style="padding: 0 8px;">Name</th><th style="padding: 0 8px;">Frequency</th></tr>`
);
for (i in obj) {
  document.write(
    `<tr><td style="border: 1px solid black; padding: 0 8px">${i}</td><td style="border: 1px solid black; padding: 0 8px">${obj[i]}</td></tr>`
  );
}
