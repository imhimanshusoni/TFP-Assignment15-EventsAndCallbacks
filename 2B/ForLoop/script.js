...
for (let i = 0; i < data.recipes.length; ++i) {
  if (data.recipes[i].rating > 4.5) {
    ...
    console.log(`${data.recipes[i].name} : ${data.recipes[i].cuisine}`);
    document.write(
      `<tr><td style="border: 1px solid black;">${data.recipes[i].name}</td><td style="border: 1px solid black;">${data.recipes[i].cuisine}</td></tr>`
    );
  }
}
