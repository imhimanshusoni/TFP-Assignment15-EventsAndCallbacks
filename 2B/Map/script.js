...
data.recipes.map(Operations);

function writeDocument(element) {
  document.write(
    `<tr><td style="border: 1px solid black;">${element.name}</td><td style="border: 1px solid black;">${element.cuisine}</td></tr>`
  );
}
