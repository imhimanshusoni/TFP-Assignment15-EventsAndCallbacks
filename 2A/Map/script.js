...
data.recipes.map(pushElements);

function HTMLPrint(item) {
  document.write(
    `<tr><td style="border: 1px solid black;">${item.name}</td><td style="border: 1px solid black;">${item.cuisine} <br></td></tr>`
  );
}
