...
for (let i = 0; i < arr.length; ++i) {
  console.log(`${arr[i].name} : ${arr[i].cuisine}`);
  document.write(
    `<tr><td style="border: 1px solid black;">${arr[i].name}</td><td style="border: 1px solid black;">${arr[i].cuisine}</td></tr>`
  );
}
